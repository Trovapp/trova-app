...
// 탭바 라벨이자, 탭에서 들어간 스택 화면의 iOS 뒤로가기 문구(RootNavigator)로도 쓴다.
export const TAB_LABEL: Record<keyof MainTabParamList, string> = {
  Home: "홈",
  PlacesList: "영상 기록",
  TripsList: "내 여행",
  SavedPlaces: "찜한 장소",
...
export function MainTabs() {
  ...
  return (
    ...
    >
      <Tab.Screen name="Home" component={HomeScreen} options={{ title: "Trova", tabBarLabel: TAB_LABEL.Home }} />
      <Tab.Screen
        name="PlacesList"
      ...
      <Tab.Screen name="SavedPlaces" component={SavedPlacesScreen} options={{ title: "찜한 장소", tabBarLabel: TAB_LABEL.SavedPlaces }} />
      <Tab.Screen name="MyPage" component={MyPageScreen} options={{ title: "마이페이지", tabBarLabel: TAB_LABEL.MyPage }} />
    </Tab.Navigator>
  );
}
